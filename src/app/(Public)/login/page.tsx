...
return(
 <div className=" h-screen w-screen relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
  <img
    alt=""
  ...
  <ModalsLogin show={show} onClose={onClose} seller={seller} setSeller={setSeller}/>
  </div>
  )
}
